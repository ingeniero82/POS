...
class ElectronicInvoicePaymentModal extends StatefulWidget {
  ...
  @override
  State<ElectronicInvoicePaymentModal> createState() =>
      _ElectronicInvoicePaymentModalState();
}

class _ElectronicInvoicePaymentModalState
    extends State<ElectronicInvoicePaymentModal> {
  ...
  void _selectInvoice(Map<String, dynamic> invoice) {
    setState(() {
      ...
      _amountController.text =
          (invoice['pending_amount'] as double).toStringAsFixed(2);
    });
  }
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      final success = await ElectronicInvoicingIntegrationService
                                        ...
                                        child: ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  'Pendiente: \$${(invoice['pending_amount'] as double).toStringAsFixed(2)}'),
                                            ],
                                          ),
                                          trailing: Text(
                                            '${invoice['status']}',
