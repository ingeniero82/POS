...
class InvoiceDetailsWidget extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Documento',
                '${invoice.clientDocumentType} ${invoice.clientDocumentNumber}'),
            ...
            _buildInfoRow(
                'Dirección', invoice.clientAddress ?? 'No especificada'),
            _buildInfoRow('Ciudad', invoice.clientCity ?? 'No especificada'),
            _buildInfoRow(
                'Departamento', invoice.clientDepartment ?? 'No especificado'),
            _buildInfoRow('Responsabilidad Fiscal',
                invoice.clientFiscalResponsibility ?? 'No especificada'),
          ],
        ),
      ),
    );
  ...
  // ✅ Fila de total
  Widget _buildTotalRow(String label, double amount, bool isDiscount,
      {bool isTotal = false}) {
    return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ...controller.statusHistory
                  .map((tracking) => _buildStatusTrackingRow(tracking)),
            ],
          ),
        ),
      );
  ...
  void _sendToDIAN() {
    controller.sendInvoiceToDIAN(
      ...
      userId:
          'usuario_actual', // En una implementación real se obtendría del sistema
    );
  }
