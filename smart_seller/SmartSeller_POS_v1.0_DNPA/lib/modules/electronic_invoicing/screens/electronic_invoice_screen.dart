...
class ElectronicInvoiceScreen extends StatefulWidget {
  ...
  @override
  State<ElectronicInvoiceScreen> createState() =>
      _ElectronicInvoiceScreenState();
}

class _ElectronicInvoiceScreenState extends State<ElectronicInvoiceScreen>
    with SingleTickerProviderStateMixin {
  final ElectronicInvoiceController _controller =
      Get.put(ElectronicInvoiceController());
  ...
  final String _selectedPaymentMethod = 'Efectivo';
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => TextFormField(
                      ...
                      onChanged: (value) =>
                          _controller.updateInvoiceNumber(value),
                ...
                Obx(() => TextFormField(
                      ...
                      onTap: () async {
                        ...
                        if (picked != null) {
                          ...
                          _controller
                              .updateIssueDate(_issueDateController.text);
                        }
                      },
                    )),
              ],
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => DropdownButtonFormField<String>(
                      initialValue: _controller.paymentMethod.value,
                      items: [
                        'Efectivo',
                        'Tarjeta Débito',
                        'Tarjeta Crédito',
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => TextFormField(
                      ...
                      onChanged: (value) =>
                          _controller.updateObservations(value),
                      maxLines: 4,
                      decoration: const InputDecoration(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Obx(() => DropdownButtonFormField<String>(
                      initialValue: _controller.clientType.value,
                      items: ['CUANTIAS MENORES', 'CLIENTE REGISTRADO']
                          ...
                          .toList(),
                      onChanged: (value) =>
                          _controller.updateClientType(value!),
                      decoration: const InputDecoration(
                        border: OutlineInputBorder(),
                        contentPadding:
                            EdgeInsets.symmetric(horizontal: 12, vertical: 16),
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => TextFormField(
                      onChanged: (value) =>
                          _controller.updateClientAddress(value),
                      maxLines: 3,
                      decoration: const InputDecoration(
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => TextFormField(
                      onChanged: (value) =>
                          _controller.updateClientPhone(value),
                      decoration: const InputDecoration(
            ...
            Column(
              ...
              children: [
                ...
                Obx(() => TextFormField(
                      onChanged: (value) =>
                          _controller.updateClientEmail(value),
                      decoration: const InputDecoration(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          const Text('Subtotal:'),
                          Text(
                              '\$${_controller.subtotal.value.toStringAsFixed(2)}'),
                        ],
                      ),
                      const SizedBox(height: 8),
                      Row(
