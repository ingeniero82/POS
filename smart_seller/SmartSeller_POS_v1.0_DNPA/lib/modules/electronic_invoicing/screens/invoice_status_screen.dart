...
class InvoiceStatusScreen extends StatelessWidget {
  ...
  void _showFiltersDialog(BuildContext context, InvoiceStatusController controller) {
    showDialog(
      context: context,
  ...
  void _showNewInvoiceDialog(BuildContext context, InvoiceStatusController controller) {
