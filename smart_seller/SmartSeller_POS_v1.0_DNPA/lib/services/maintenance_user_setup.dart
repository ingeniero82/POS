...
class MaintenanceUserSetup {
  ...
  static Future<bool> createDefaultMaintenanceUser() async {
    try {
      ...
      final existingUser = await SQLiteDatabaseService.findUser('maintenance', 'maint123');
      ...
      final createdUser = await SQLiteDatabaseService.findUser('maintenance', 'maint123');
      if (createdUser != null) {
  ...
  static Future<bool> changeMaintenancePassword(String newPassword) async {
    try {
      ...
      final updatedUser = await SQLiteDatabaseService.findUser('maintenance', newPassword);
      if (updatedUser != null) {
