...
class _AuthorizationModalState extends State<AuthorizationModal> {
            ...
            if (!_showBarcodeScanner) ...[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      'Formato: USR-1234 (código de usuario) o ADMIN123 (código de autorización)',
                ),
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      ...
      if (isAuthorized) {
        ...
        final authorizerInfo =
            await _authService.getAuthorizerInfo(_codeController.text.trim());
  ...
  Future<void> _scanBarcode() async {
    ...
    const scannedCode = 'ADMIN001'; // Código de ejemplo
    ...
    try {
      ...
      if (isAuthorized) {
        // Obtener información del autorizador para el log
        final authorizerInfo =
            await _authService.getAuthorizerInfo(scannedCode);
