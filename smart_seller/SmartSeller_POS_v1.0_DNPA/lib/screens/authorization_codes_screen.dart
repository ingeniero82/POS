  ...
  Future<void> _deactivateCode(AuthorizationCode code) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
            '¿Estás seguro de que quieres desactivar el código de ${code.name}?'),
        actions: [
          TextButton(
  ...
  Future<void> _resetToDefaults() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
            '¿Estás seguro de que quieres reiniciar todos los códigos a los valores predefinidos? Esto eliminará todos los códigos personalizados.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(false),
            child: const Text('Cancelar'),
