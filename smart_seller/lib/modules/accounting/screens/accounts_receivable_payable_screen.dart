...
class AccountsReceivablePayableScreen extends StatefulWidget {
  ...
  @override
  State<AccountsReceivablePayableScreen> createState() => _AccountsReceivablePayableScreenState();
}

class _AccountsReceivablePayableScreenState extends State<AccountsReceivablePayableScreen> with SingleTickerProviderStateMixin {
