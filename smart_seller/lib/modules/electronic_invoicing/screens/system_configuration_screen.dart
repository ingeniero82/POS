...
class _SystemConfigurationScreenState extends State<SystemConfigurationScreen> {
  ...
  Future<void> _loadConfiguration() async {
    ...
    try {
      ...
      setState(() {
        ...
        _currentConsecutiveController.text =
            config.currentConsecutive.toString();
  ...
  Future<void> _saveConfiguration() async {
    ...
    try {
      final config = SystemConfiguration(
        ...
        currentConsecutive:
            int.tryParse(_currentConsecutiveController.text.trim()) ?? 1,
      ...
      final success =
          await SystemConfigurationService.saveConfiguration(config);
  ...
  Future<void> _loadDefaultTestConfiguration() async {
    final success =
        await SystemConfigurationService.loadDefaultTestConfiguration();
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                helperText:
                    'Número de la resolución DIAN que autoriza la facturación',
              ),
              validator: (value) {
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                helperText:
                    'Rango de consecutivos permitidos por la resolución',
              ),
              validator: (value) {
                if (value == null || value.trim().isEmpty) {
