...
class PendingInvoiceQueueScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed:
            controller.canPerformRetries ? controller.retryAllAvailable : null,
        backgroundColor: Get.theme.colorScheme.primary,
        foregroundColor: Get.theme.colorScheme.onPrimary,
        icon: const Icon(Icons.refresh),
              ...
              if (controller.hasItemsNeedingRetry)
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: controller.canPerformRetries
                        ? controller.retryAllAvailable
                        : null,
                    icon: const Icon(Icons.refresh),
              ...
              if (controller.hasCompletedItems) ...[
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(
                        'Limpiar Completados (${controller.completedCount})'),
                    style: ElevatedButton.styleFrom(
  ...
  void _showRetryConfigDialog(
      BuildContext context, PendingInvoiceQueueController controller) {
    showDialog(
      context: context,
