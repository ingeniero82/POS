...
class _CashPickupsScreenState extends State<CashPickupsScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    DropdownMenuItem(
                        value: 'Retiro parcial', child: Text('Retiro Parcial')),
                    DropdownMenuItem(
                        value: 'Pago a proveedor',
                        child: Text('Pago a Proveedor')),
                    DropdownMenuItem(
                        value: 'Gasto operativo',
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        try {
                          ...
                          final cashSession =
                              await AccountingService.getOpenCashSession();
                          if (cashSession == null) {
                            Get.snackbar(
                              'Error',
  ...
  Future<void> _showDeleteConfirmation(CashPickup pickup) async {
    ...
    if (confirmed == true) {
      try {
        final success =
            await SQLiteDatabaseService.deleteCashPickup(pickup.id!);
        if (success) {
          Get.snackbar(
            '✅ Eliminado',
                              ...
                              child: ListTile(
                                ...
                                trailing: IconButton(
                                  icon: const Icon(Icons.delete,
                                      color: Colors.red),
                                  onPressed: () =>
                                      _showDeleteConfirmation(pickup),
                                ),
                              ),
                            );
                          },
