...
class _CompanyConfigScreenState extends State<CompanyConfigScreen> {
  ...
  bool _autoMaintenanceEnabled = true; // Por defecto activado
  ...
  Future<void> _loadCurrentConfig() async {
    try {
      ...
      final autoMaintenance = await ConfigService.isAutoMaintenanceEnabled();
      setState(() {
        _autoMaintenanceEnabled = autoMaintenance;
        ...
        _countryController.text =
            config.country ?? 'CO'; // Por defecto Colombia
  ...
  Future<void> _saveConfig() async {
    ...
    try {
      final updatedConfig = CompanyConfig(
        ...
        nitNumber: _nitNumberController.text.trim().isEmpty
            ? null
            : _nitNumberController.text.trim(),
        verificationDigit: _verificationDigitController.text.trim().isEmpty
            ? null
            : _verificationDigitController.text.trim(),
        ...
        fiscalRegime: _fiscalRegimeController.text.trim().isEmpty
            ? null
            : _fiscalRegimeController.text.trim(),
        fiscalResponsibilities:
            _fiscalResponsibilitiesController.text.trim().isEmpty
                ? null
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser == null ||
        !permissionsService.hasPermission(
            currentUser.role, Permission.accessCompanyConfig)) {
      return Scaffold(
        appBar: AppBar(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        border: OutlineInputBorder(),
                        helperText:
                            '31 = NIT (obligatorio para facturación electrónica)',
                      ),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        border: OutlineInputBorder(),
                        helperText:
                            'Aparece en la parte inferior de la factura',
                      ),
                      maxLines: 3,
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _headerTextController.text.isEmpty
                                ? 'FACTURA DE VENTA'
                          ...
                          Text(_companyNameController.text.isEmpty
                              ? 'MI EMPRESA POS'
                          ...
                          Text(
                              'Tel: ${_phoneController.text.isEmpty ? 'Teléfono' : _phoneController.text}'),
                          const SizedBox(height: 8),
                          const Text(
                              '----------------------------------------'),
                    ...
                    // Separador para configuración del sistema
                    // Solo visible para admin o usuarios con permiso modifySettings
                    if (currentUser.role == UserRole.admin ||
                        permissionsService.hasPermission(
                            currentUser.role, Permission.modifySettings)) ...[
                      const Divider(),
                      const SizedBox(height: 16),
                      ...
                      // Switch para mantenimiento automático
                      Card(
                        elevation: 2,
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _autoMaintenanceEnabled
                                              ? 'Optimiza automáticamente la base de datos para mejor rendimiento'
                                              : 'Desactivado - La base de datos no se optimizará automáticamente',
                                          style: TextStyle(
                                            fontSize: 12,
                                        ...
                                        const SizedBox(height: 8),
                                        Text(
                                          '⚠️ IMPORTANTE: Solo optimiza (reorganiza datos), NO borra información',
                                          style: TextStyle(
                                            fontSize: 11,
                                  ...
                                  Switch(
                                    ...
                                    onChanged: (value) {
                                      ...
                                      if (value) {
                                        ConfigService.enableAutoMaintenance();
                                      } else {
                                        ConfigService.disableAutoMaintenance();
                                      }
                                      Get.snackbar(
                                        'Configuración guardada',
                                        value
                                            ? 'Mantenimiento automático activado'
