  ...
  static Future<Map<String, dynamic>> generateTaxDeclarationSummary({
    ...
    return {
      ...
      'ivaSummary': {
        ...
        'ivaGenerado': {
          'tasa0': {
            'base': summary['salesBreakdown']['taxedAmount'] *
                (summary['vatBreakdown']['vatAt0'] /
                    summary['vatBreakdown']['totalVat']),
            'impuesto': summary['vatBreakdown']['vatAt0'],
          },
          'tasa5': {
            'base': summary['salesBreakdown']['taxedAmount'] *
                (summary['vatBreakdown']['vatAt5'] /
                    summary['vatBreakdown']['totalVat']),
            'impuesto': summary['vatBreakdown']['vatAt5'],
          },
          'tasa19': {
            'base': summary['salesBreakdown']['taxedAmount'] *
                (summary['vatBreakdown']['vatAt19'] /
                    summary['vatBreakdown']['totalVat']),
