  ...
  void initState() {
    ...
    if (widget.product != null) {
      ...
      if (_ipoConsumoRate != null) {
        _ipoConsumoRateController.text =
            (_ipoConsumoRate! * 100).toString(); // Mostrar como porcentaje
      }
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  initialValue:
                      _vatRate == 0.0 ? '0' : (_vatRate == 0.05 ? '5' : '19'),
                  items: const [
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      setState(() {
                        _vatRate =
                            value == '19' ? 0.19 : (value == '5' ? 0.05 : 0.0);
              ...
              children: [
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    initialValue: _ipoConsumoType,
                    items: const [
                      DropdownMenuItem(value: 'LICOR', child: Text('Licor')),
                      DropdownMenuItem(
                          value: 'CIGARRILLOS', child: Text('Cigarrillos')),
