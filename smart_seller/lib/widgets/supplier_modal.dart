                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      onChanged: (value) {
                                        documentTypeController.text = value ?? 'NIT';
                                      },
                                    ),
                                  ),
                                  const SizedBox(width: 12),
                                ...
                                children: [
                                  Expanded(
                                    child: DropdownButtonFormField<String>(
                                      ...
                                      items: const [
                                        DropdownMenuItem(value: 'Responsable de IVA', child: Text('Responsable de IVA')),
                                        DropdownMenuItem(value: 'No Responsable de IVA', child: Text('No Responsable de IVA')),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.contact_phone, color: Colors.purple.shade700),
                                  const SizedBox(width: 8),
                                  const Text(
                                    'Información de Contacto',
                                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
    ...
    if (result == true) {
      try {
        final newSupplier = Supplier(
          ...
          documentType: documentTypeController.text.trim().isEmpty ? null : documentTypeController.text.trim(),
          ...
          country: countryController.text.trim().isEmpty ? 'Colombia' : countryController.text.trim(),
          taxRegime: taxRegimeController.text.trim().isEmpty ? null : taxRegimeController.text.trim(),
          economicActivity: economicActivityController.text.trim().isEmpty ? null : economicActivityController.text.trim(),
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      if (widget.onPaymentProcessed != null) {
        widget.onPaymentProcessed!(_selectedSupplier!, amount, _selectedPaymentMethod);
      }
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Builder(
                                      builder: (context) {
                                        final validation = SupplierService.validateSupplierForElectronicInvoicing(supplier);
                                        final isComplete = validation['isComplete'] as bool;
                                        final completionPercentage = validation['completionPercentage'] as int;
                                        ...
                                        return Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                isComplete ? 'FE Completo' : '$completionPercentage%',
                                                style: TextStyle(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.bold,
                                                  color: isComplete ? Colors.green.shade700 : Colors.orange.shade700,
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(_isProcessingPayment ? 'Procesando...' : 'Procesar Pago'),
