# 📄 CÓDIGO FUENTE - SmartSeller POS v2.0

## 📋 INFORMACIÓN DEL SISTEMA
- **Nombre del Software:** SmartSeller POS
- **Versión:** 2.0 Final
...
│   └── electronic_invoicing/   # Módulo de facturación electrónica DIAN
...
### **2. pubspec.yaml - Configuración del Proyecto**
```yaml
name: smart_seller
description: Sistema POS Smart Seller
...
### **1. SQLiteDatabaseService - Gestión de Base de Datos**
```dart
// Servicio principal para la gestión de la base de datos SQLite
// Maneja la inicialización, creación de tablas y operaciones CRUD
// Ubicación: lib/services/sqlite_database_service.dart
```

### **2. AuthService - Autenticación de Usuarios**
```dart
// Servicio de autenticación y gestión de sesiones
// Maneja login, logout, validación de usuarios
// Ubicación: lib/services/auth_service.dart
```

### **3. PermissionsService - Control de Permisos**
```dart
// Sistema granular de permisos por rol de usuario
// Roles: Administrador, Vendedor, Mantenimiento
// Ubicación: lib/services/permissions_service.dart
```

### **4. PrintService - Servicio de Impresión**
```dart
// Gestión de impresión de tickets y facturas
// Soporte para impresoras térmicas y láser
// Ubicación: lib/services/print_service.dart
```

### **5. CompanyConfigService - Configuración de Empresa**
```dart
// Gestión de datos de la empresa y configuración DIAN
...
```dart
// Pantalla principal con acceso a todos los módulos
// Navegación por tarjetas con iconos
// Ubicación: lib/screens/dashboard_screen.dart
```

### **3. PosScreen - Punto de Venta**
```dart
// Pantalla principal del POS con funcionalidades:
...
### **4. ProductsScreen - Gestión de Productos**
```dart
...
### **5. CustomersScreen - Gestión de Clientes**
```dart
...
```
modules/electronic_invoicing/
├── controllers/                 # Controladores específicos
├── models/                      # Modelos de datos DIAN
...
- Generación de facturas electrónicas según estándares DIAN
...
2. **Product** - Productos e inventario
3. **Customer** - Clientes
4. **Sale** - Ventas realizadas
5. **SaleItem** - Items de cada venta
6. **Company** - Datos de la empresa
7. **ElectronicDocument** - Facturas electrónicas
8. **Permission** - Permisos del sistema
...
- **Backend:** Dart
- **Base de Datos:** SQLite
- **Estado:** GetX (Reactive Programming)
...
- `libserialport` - Comunicación con balanzas
...
- Balanza integrada para productos pesados
...
**Fecha de Compilación:** Diciembre 2024  
**Versión del Compilador:** Flutter 3.16.0  
